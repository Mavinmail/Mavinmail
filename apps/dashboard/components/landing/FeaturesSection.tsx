...
export function FeaturesSection() {
  return (
    <section id="features" className="py-28 bg-[#0C0C0C] border-t border-white/[0.04]">
        ...
        <div className="grid md:grid-cols-2 gap-px bg-white/[0.04] rounded-lg overflow-hidden border border-white/[0.06]">
          {features.map((feature, idx) => (
            <motion.div
              ...
              className="bg-[#0C0C0C] p-8 group hover:bg-[#111111] transition-colors"
            >
              <div className="w-10 h-10 rounded-lg border border-white/[0.06] bg-[#161616] flex items-center justify-center mb-5 group-hover:border-[#24D3EE]/20 transition-colors">
                {feature.icon}
              </div>
